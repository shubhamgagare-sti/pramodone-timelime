...
export default function RootCauseAnalysis() {
  ...
  const rootCauses = [
    ...
    {
      id: 'vision-gap',
      title: 'Internal Misalignment: Vision & Execution Gap',
      subtitle: 'Strategic Intent & Manual Workflows',
    ...
    {
      id: 'report-misalignment',
      title: 'Report-Based Development Misalignment',
      subtitle: 'Initial Phase: Forms & Data Requirements',
      image: '/images/report-misalignment.png',
      keyInsight: 'Critical "Report & Requirement" misalignment: Dev team built forms based on uploaded reports instead of raw data requirements. This necessitated significant rework to align with the actual data structure needed.',
      severity: 'critical',
      icon: FileX,
    },
    {
      id: 'task-manager-rework',
      title: 'Task Manager Logic Overhaul',
      subtitle: 'Scope Shift: Checklist to Frequency Model',
      image: '/images/task-manager-rework.png',
      keyInsight: 'Major rework: Checklists moved from task-level assignment to Daily/Monthly/Yearly frequency model with added Acceptance Criteria. This fundamentally changed the logic and reset Pramod\'s development timeline.',
      severity: 'critical',
      icon: TrendingDown,
    },
  ];
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className={`p-3 rounded-lg flex-shrink-0 ${rootCauses[activeIndex].severity === 'critical'
              ...
              <div className={`px-4 py-2 rounded-full text-xs font-semibold whitespace-nowrap ${rootCauses[activeIndex].severity === 'critical'
            ...
            <div className={`p-4 rounded-lg border-l-4 ${rootCauses[activeIndex].severity === 'critical'
